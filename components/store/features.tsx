...
const features = [
  {
    ...
    description:
      "По Минску доступен самовывоз и доставка, по Беларуси доставка Европочтой. Отправка в течение 1-2 рабочих дней. Доставка курьером или почтой по всей Беларуси.",
  },
  {
    icon: Shield,
...
export function Features() {
  ...
  return (
    <section
      ref={ref}
      className="px-6 lg:px-12 py-20 lg:py-28 border-y border-border"
    >
      <div
